...
import { Trash, Star, Calendar, Moon, Users, Phone, Mail } from "lucide-react";
                                            ...
                                            <div className="flex items-center gap-4 p-4 bg-surface border border-accent rounded-xl">
                                                ...
                                                {parseInt(tripDetails.organizator_id) === userId && (
                                                    <div className="flex items-center gap-4 text-sm text-muted">
                                                        <span className="flex items-center gap-1"><Phone size={14}/>{sudionik.telefon}</span>
